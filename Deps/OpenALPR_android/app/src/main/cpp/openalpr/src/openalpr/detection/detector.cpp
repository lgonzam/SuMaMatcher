...
#define CV_WINDOW_KEEPRATIO WINDOW_KEEPRATIO
#define CV_GUI_EXPANDED WINDOW_GUI_EXPANDED
//#define cvGetWindowHandle cv::getWindowHandle
...
namespace alpr
{
  ...
  vector<PlateRegion> Detector::detect(Mat frame, std::vector<cv::Rect> regionsOfInterest)
  {
    ...
    {
      // OPENCV ADAPT INI
      __DEBUG_CV("detector.cpp, Detection Mask");
